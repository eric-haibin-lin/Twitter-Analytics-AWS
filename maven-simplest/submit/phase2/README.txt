...
In Folder frontend, the HelloWorldEmbedded.java is for handling Q1 Q2 Q3 Q4 requests. The Profiler.java is used to generate profile data for the report. Note that we use vertx 3 framework for the frontend.
