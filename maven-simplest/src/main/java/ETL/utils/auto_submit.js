...
var DNS = 'ec2-54-152-43-91.compute-1.amazonaws.com'		//The web server's DNS
var QUERY_LIST = ['Q2-MySQL', 'Q2-HBase', 'Q3-MySQL', 'Q3-HBase', 'Q4-MySQL', 'Q5-MySQL', 'Q6-MySQL'] //Do not modify this 
var QUERY = QUERY_LIST[6];		//Which query to test
var DURATION = '60';			//Duration in seconds


var FORM_URL = '/twitter/submit/';
var POST = 'POST';
var TASK = '63';	//Task: Development 
var PROJECT = 'p619-phase3';
var INTERVAL = '70000';
